...
politics_url = 'https://www.gazeta.ru/politics/news/'
politics_ans = requests.get(politics_url)
politics_soup = BeautifulSoup(politics_ans.text, 'html.parser')


def get_politics_news():
    news_massive = politics_soup.find_all('div', class_='b_ear m_techlisting')
