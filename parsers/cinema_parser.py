...
cinema_url = 'https://www.kinomania.ru/news'
cinema_ans = requests.get(cinema_url)
cinema_soup = BeautifulSoup(cinema_ans.text, 'html.parser')


def get_cinema_news():
    news_massive = cinema_soup.find_all('div', class_='pagelist-item clear')
