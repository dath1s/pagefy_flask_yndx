...
medicine_url = 'https://www.rbc.ru/tags/?tag=%D0%BC%D0%B5%D0%B4%D0%B8%D1%86%D0%B8%D0%BD%D0%B0'
medicine_ans = requests.get(medicine_url)
medicine_soup = BeautifulSoup(medicine_ans.text, 'html.parser')


def get_medicine_news():
    news_massive = medicine_soup.find_all('div', class_='search-item js-search-item')
